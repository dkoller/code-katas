...
public class MonthlyGrossSalaryCalculatorShould {
    ...
    @Test
    public void calculate_monthly_gross_salary_for_gross_annual_salary_24000() {
    ...
    @Test
    public void calculate_monthly_gross_salary_for_gross_annual_salary_49200() {
        MonthlyGrossSalaryCalculator monthlyGrossSalaryCalculator = new MonthlyGrossSalaryCalculator();
        AnnualGrossSalary annualGrossSalary = new AnnualGrossSalary(49200);
        MonthlyGrossSalary monthlyGrossSalary = new MonthlyGrossSalary(4100);
        assertThat(monthlyGrossSalaryCalculator.calculate(annualGrossSalary), is(monthlyGrossSalary));
    }
}
